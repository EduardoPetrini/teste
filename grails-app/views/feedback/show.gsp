	...
	<body>
		...
		<div id="show-feedback" class="content scaffold-show" role="main">
			...
			<ol class="property-list feedback">
				...
				<g:if test="${feedbackInstance?.dateCreate}">
				<li class="fieldcontain">
					<span id="dateCreate-label" class="property-label"><g:message code="feedback.dateCreate.label" default="Date Create" /></span>
					
						<span class="property-value" aria-labelledby="dateCreate-label"><g:formatDate date="${feedbackInstance?.dateCreate}" /></span>
					
				</li>
				</g:if>
			
				<g:if test="${feedbackInstance?.lastUpdate}">
				<li class="fieldcontain">
					<span id="lastUpdate-label" class="property-label"><g:message code="feedback.lastUpdate.label" default="Last Update" /></span>
					
						<span class="property-value" aria-labelledby="lastUpdate-label"><g:formatDate date="${feedbackInstance?.lastUpdate}" /></span>
